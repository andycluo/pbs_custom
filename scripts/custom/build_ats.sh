...
srcpath1="/opt/deploy/coderepo/tob/custom/tob-ats/"
destpath="/opt/deploy/repo/project/tob/custom/tob-ats/"
codepath1="/opt/deploy/repo/project/tob/custom/tob-ats/tob-ats/"

cpath=`pwd`

if [ ! -d $srcpath1 ];then
   cd /opt/deploy/coderepo/tob/custom;git clone git@192.168.1.199:web/tob-ats.git
fi
...
docker build --no-cache=true -t docker.ifchange.com/projects/tobcustom/$pro:latest .
